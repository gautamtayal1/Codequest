...
--
-- Name: ar_internal_metadata; Type: TABLE; Schema: public; Owner: judge0
--
...
ALTER TABLE public.ar_internal_metadata OWNER TO judge0;

--
-- Name: clients; Type: TABLE; Schema: public; Owner: judge0
--
...
ALTER TABLE public.clients OWNER TO judge0;

--
-- Name: languages; Type: TABLE; Schema: public; Owner: judge0
--
...
ALTER TABLE public.languages OWNER TO judge0;

--
-- Name: languages_id_seq; Type: SEQUENCE; Schema: public; Owner: judge0
--
...
ALTER TABLE public.languages_id_seq OWNER TO judge0;

--
-- Name: languages_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: judge0
--
...
--
-- Name: schema_migrations; Type: TABLE; Schema: public; Owner: judge0
--
...
ALTER TABLE public.schema_migrations OWNER TO judge0;

--
-- Name: submissions; Type: TABLE; Schema: public; Owner: judge0
--
...
ALTER TABLE public.submissions OWNER TO judge0;

--
-- Name: submissions_id_seq; Type: SEQUENCE; Schema: public; Owner: judge0
--
...
ALTER TABLE public.submissions_id_seq OWNER TO judge0;

--
-- Name: submissions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: judge0
--
...
--
-- Name: languages id; Type: DEFAULT; Schema: public; Owner: judge0
--
...
--
-- Name: submissions id; Type: DEFAULT; Schema: public; Owner: judge0
--
...
environment	production	2025-04-16 06:40:49.439126	2025-04-16 06:40:49.439126
\.
...
--
-- Name: ar_internal_metadata ar_internal_metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: judge0
--
...
--
-- Name: clients clients_pkey; Type: CONSTRAINT; Schema: public; Owner: judge0
--
...
--
-- Name: languages languages_pkey; Type: CONSTRAINT; Schema: public; Owner: judge0
--
...
--
-- Name: schema_migrations schema_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: judge0
--
...
--
-- Name: submissions submissions_pkey; Type: CONSTRAINT; Schema: public; Owner: judge0
--
...
--
-- Name: index_submissions_on_token; Type: INDEX; Schema: public; Owner: judge0
--
